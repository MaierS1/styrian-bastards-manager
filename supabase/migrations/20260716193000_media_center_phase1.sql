...
-- Bestehende Sichtbarkeitsflags in das neue Kanalmodell uebernehmen.
...
-- Phase 1: Zugriff nur fuer angemeldete App-Nutzer. Eine feinere Zuordnung
-- zu den bestehenden Media-Center-RBAC-Rechten erfolgt ueber die App und kann
-- spaeter ohne Schema-Aenderung in Policies nachgeschaerft werden.
